...
public class MainMS implements Serializable {
    ...
    private static final String SQLSERVER_USERNAME = System.getenv("SQLSERVER_USERNAME");
    private static final String SQLSERVER_PWD = System.getenv("SQLSERVER_PWD");
    private static final String SQLSERVER_HOST_PORT = System.getenv("SQLSERVER_HOST_PORT");
    private static final String SQLSERVER_DB = System.getenv("SQLSERVER_DB");
    private static final String SQLSERVER_TABLE = System.getenv("SQLSERVER_TABLE");
    ...
    private static final String AWS_S3_BUCKET = System.getenv("AWS_S3_BUCKET");
    ...
    public static void main(String[] args) {
        ...
        jdbcDF.select("*").write().format("com.databricks.spark.csv").
          save("s3n://" + AWS_ACCESS_KEY_ID + ":" + AWS_SECRET_ACCESS_KEY + "@" + AWS_S3_BUCKET);
